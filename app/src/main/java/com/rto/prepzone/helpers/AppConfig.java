...
public class AppConfig extends Application implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityResumed(@NonNull Activity activity) {
        mCurrentActivity = (AppCompatActivity) activity;
      //  String previousActivity = ((ContextWrapper) progressDialog.getContext()).getBaseContext().getClass().getSimpleName();
        String currentActivity = mCurrentActivity.getClass().getSimpleName();
